...
do
    ...
    elseif locale == "frFR" then
        ...
        CrossGambling.L[".:Welcome to CrossGambling:. User's Roll - (%s) - Type 1 to Join (-1 to withdraw)"] = ".:Bienvenue dans le jeu des PO:. Pièces d'or en jeu : (%s) - Tapez 1 pour rejoindre  (-1 pour annuler)"
