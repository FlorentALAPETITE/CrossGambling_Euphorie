...
do
    ...
    if locale == "enUS" or locale == "enGB" then
        ...
        CrossGambling.L["%s owes %s %s gold and %s gold the guild bank!"] =
            "%s owes %s %s gold and %s gold the guild bank!"
        CrossGambling.L["%s can now set the next gambling amount by saying !amount x"] =
            "%s can now set the next gambling amount by saying !amount x"
        CrossGambling.L["It was a tie! No payouts on this roll!"] = "It was a tie! No payouts on this roll!"
        CrossGambling.L[".:Welcome to CrossGambling:. User's Roll - (%s) - Type 1 to Join (-1 to withdraw)"] =
            ".:Welcome to CrossGambling:. User's Roll - (%s) - Type 1 to Join (-1 to withdraw)"
    ...
    elseif locale == "deDE" then
        ...
        CrossGambling.L["%s owes %s %s gold and %s gold the guild bank!"] =
            "%s schuldet %s %s gold und %s Gold der Gildenbank!"
        CrossGambling.L["%s can now set the next gambling amount by saying !amount x"] =
            "%s kann nun den Einsatz der nächsten Spielrunde festlegen. - !amount x"
        CrossGambling.L["It was a tie! No payouts on this roll!"] = "Unentschieden! Keine Auszahlungen auf diese Runde!"
        CrossGambling.L[".:Welcome to CrossGambling:. User's Roll - (%s) - Type 1 to Join (-1 to withdraw)"] =
            ".:Willkommen bei CrossGambling:. Nutzer würfeln - (%s) - Tippe 1 zum Teilnehmen (-1 um nicht mehr Teilzunehmen.)"
    ...
    elseif locale == "frFR" then
        ...
        CrossGambling.L["%s owes %s %s gold and %s gold the guild bank!"] =
            "%s doit donner à %s %s pièces d'or et mettre %s pièces d'or dans la banque de guilde !"
        CrossGambling.L["%s can now set the next gambling amount by saying !amount x"] =
            "%s peut maintenant décider de l'enjeu du prochain pari avec !amount x"
        CrossGambling.L["It was a tie! No payouts on this roll!"] = "C'est une égalité ! Pas de paiement pour ce pari!"
        CrossGambling.L[".:Welcome to CrossGambling:. User's Roll - (%s) - Type 1 to Join (-1 to withdraw)"] =
            ".:Bienvenue dans le jeu des PO:. Pièces d'or en jeu : (%s) - Tapez 1 pour rejoindre  (-1 pour annuler)"
